<template>
  <div class="app-container">
    ...
    <div class="head-container">
      <!-- 搜索 -->
      <el-row>
        <el-col :span="6" v-if="collegeId==null">
          选择学院:
...
<script>
  ...
  export default {
    ...
    created() {
      this.collegeId = this.$store.state.user.user.collegeId
      ...
      listajaxSpecialty(this.collegeId).then(res => {
        this.specialty = res
      })
      this.load()
    },
    methods: {
      ...
      add() {
        ...
        this.$refs.form.form['collegeId'] = this.collegeId
      },
      edit(data) {
        this.isAdd = false
