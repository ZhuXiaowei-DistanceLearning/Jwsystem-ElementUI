  ...
  >
    <el-form ref="form" :model="form" :rules="rules" size="small" label-width="80px">
      ...
      <el-form-item label="学院名称" prop="collegeId">
        <el-select v-model="form.collegeId" placeholder="请选择" @change="selectCollege" :disabled="form.collegeId == null ? false: true">
          <el-option
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      listajaxSpecialty(this.form.collegeId).then(res => {
        this.specialty = res
      })
    },
    methods: {
